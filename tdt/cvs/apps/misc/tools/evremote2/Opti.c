...
static tButton cButtonsSpideroxOpti[] = {
...
RemoteControl_t Opti_RC = {
	"Opticum9500 HD GStreamer MultiImages RemoteControl",
	Opti,
	&pInit,
	&pShutdown,
	&pRead,
	&pNotification,
	cButtonsSpideroxOpti,
	NULL,
	NULL,
  	1,
