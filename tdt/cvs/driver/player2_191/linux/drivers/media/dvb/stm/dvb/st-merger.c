...
//#if defined(UFS910) ???
#if defined(VIP2_V1) || defined(SPARK) || defined(CLASSIC) || defined(SPARK7162) || defined(IPBOX99) || defined(IPBOX55) || defined(ADB_BOX) // none ci targets
   use_cimax = 0;
#endif
...
#if  defined(FORTIS_HDBOX) || defined(UFS922) || defined(HL101) || defined(VIP1_V2) || defined(CLASSIC)
...
//-if definied (UFS910) ???
      ...
      ret = ctrl_inl(tsm_io + TSM_STREAM4_CFG);
      ctrl_outl(ret | 0x80,tsm_io + TSM_STREAM4_CFG);
#elif  defined(TF7700) || defined(UFS922) || defined(HL101) || defined(VIP1_V2) || defined(CLASSIC)
