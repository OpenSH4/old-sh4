...
release_hl101: release_common_utils
	...
	cp -dp $(buildprefix)/root/release/Scripte/system/mtd/mtd3-vip2.sh $(prefix)/release/var/config/system/mtd/
	...
	cp -R $(buildprefix)/root/var/config/system/* $(prefix)/release/var/config/system/
